...
namespace Genesis.Physics
{
    ...
    public abstract class TriggerBehavior2D : PhysicsBehavior
    {
        ...
        {
            var transform = this.Trigger.WorldTransform;
            var rotation = System.Numerics.Quaternion.CreateFromYawPitchRoll(0, 0, z);
        ...
        {
            // Translation
            var position = Trigger.WorldTransform.Translation;
